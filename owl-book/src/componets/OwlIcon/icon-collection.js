export const bar = ({ name, width = '34', height = '24', color = '', className = '', stroke = 'black' }) => (
    <svg name={name} className={className} width={width} height={height} viewBox={`0 0 ${width} ${height}`} fill={color} xmlns="http://www.w3.org/2000/svg">
        <path stroke={stroke} d="M1 12H18.3112M1 1H33M1 23H33" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
)

export const search = ({ name, width = '30', height = '30', color, className = '', stroke }) => (
    <svg name={name} className={className} width={width} height={height} viewBox={`0 0 ${width} ${height}`} fill={color} xmlns="http://www.w3.org/2000/svg">
...
export const heart = ({ name, width = '20', height = '20', color, className = '', stroke = 'black' }) => (
    <svg name={name} className={className} width={width} height={height} viewBox={`0 0 ${width} ${height}`} fill={color} xmlns="http://www.w3.org/2000/svg">
